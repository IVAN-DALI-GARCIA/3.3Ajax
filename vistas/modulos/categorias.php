		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				...
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item" id="btn-sali2"><a id="btn-salir" href="">Inicio</a></li>

                	<li class="breadcrumb-item active">Gestor Insumos</li>						
				</ol>
...
<section class="content">
    ...
    <div class="container-fluid">   
        ...
        <div class="btn-agregar-categoria btnAgregar">
            <button type="button" class="btn btn-info btn-sm mb-4" data-toggle="modal" data-target="#modal-gestionar-categoria" data-dismiss="modal"> <i class="fas fa-plus-square"></i> Agregar Material o Ingredientes</button>
        </div>
...
<div class="modal fade" id="modal-gestionar-categoria">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <!-- <div class="modal-header2 bg-info">
                <h4 class="modal-title">Gestionar Categoría</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
               ...
               <div class="row">
                   ...
                   <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ruta" id="txtRuta" placeholder="Ingrese la Insumo">
                        </div>
                   </div>
                   <div class="col-sm-4">
                        <div class="form-group">
...
<script>
    ...
    // se genera el alerta para salir de las sesiones
   function desactivaOscurecer(){
       $("#oscurecer").fadeOut();
   };
   
    function desactivaAlert(){
       $("#aviso").fadeOut(300, desactivaOscurecer);
   };
   ...
   function redireccionar(){
    ...
    function activarAlert(){
       $("#aviso").fadeIn(500);
       $("#oscurecer").click(desactivaAlert);
       $(document).keypress(desactivaAlert);
       $("#btn3").click(redireccionar);

       
   };
   
    function apareceralert(e){
        e.preventDefault();
        $("#oscurecer").fadeIn(500, activarAlert);
    }

    // function desaparealert(){
    //     event.preventDefault();
    //     $("#aviso").animate({'top':'-100'},500);
    // }

    function mostrarAlert (){
        $("#btn-salir").click(apareceralert);
        

        //salir de la sesion de la cunfiguracion hast afuera
         $("#cerrarSesion2").click(apareceralert);
         $("#cerrarSesion1").click(apareceralert);
    }



    $(document).ready (mostrarAlert);
